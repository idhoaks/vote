...
import 'package:vote24/vote2.dart';

class Vote1 extends StatefulWidget {
  @override
  _Vote1State createState() => _Vote1State();
}
...
class _Vote1State extends State<Vote1> {
            ...
            child: Column(
              children: <Widget>[
                ...
                Container(
                  ...
                  child: Text(
                    "Kira-kira siapa orang yang akan Anda pilih sebagai Presiden di pemilihan 2024?",
                    style: TextStyle(
                      fontSize: 25,
                    ),
                    textAlign: TextAlign.center,
  ...
  void dialogVote1(BuildContext context) {
    showDialog(
      context: context,
      builder: (context) {
        return Dialog(
